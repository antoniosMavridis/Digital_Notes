...
### Εκτέλεση εφαρμογής μέσω των ήδη δημιουργημένων container


Με απότερο σκοπό την διευκόληνσή σας, δοκιμάζοντας με την σειρά την οποία αναφέρονται τις παρακάτω εντολές έχετε την δυνατότητα να πλοηγηθείτε στην εφαρμογή Digital Notes φορτώνοντας τα αντίστοιχα containers. Απαιραίτητη προυπόθεση είναι να έχετε κατεβάσει τοπικά τα containers που εμπεριέχονται στο παρακάτω link. 
```
docker load <flask.tar
```
```
docker load <mong.tar
```
```
docke-compose up -d<mong.tar
```
<img src="images/run1.PNG"   /> </br>
